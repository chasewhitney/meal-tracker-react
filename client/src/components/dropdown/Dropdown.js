    ...
    return (
      <Tabs focused={this.state}>
        <LabelContainer ref={divElement => (this.divWidths[0] = divElement)}>
          <Label onClick={e => this.handleChange(1)} className="label-1">
            All
          </Label>
          <Label onClick={e => this.handleChange(2)} className="label-2">
            Branded
          </Label>
          <Label onClick={e => this.handleChange(3)} className="label-3">
            Common
          </Label>
        </LabelContainer>
        <FocusBar
